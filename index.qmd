...
FILE_CHECKLIST <- "data/processed/lista-taxonomica-referencia-mamiferos.csv"

# Field with species name in raw checklist
FIELD_SPECIES_NAME_RAW_CHECKLIST <- "Especie"

# File with raw (initial) checklist
FILE_RAW_CHECKLIST <- "data/raw/mamiferos _2020.xlsx"

# File with interim checklist
FILE_INTERIM_CHECKLIST <- "data/interim/mamiferos_2020.csv"

# GBIF QUERY of occurrences of species in checklist
GBIF_QUERY_OCCURRENCES_CHECKLIST <- "https://doi.org/10.15468/dl.zks99q"

# GBIF QUERY of occurrences in higherrank
GBIF_QUERY_OCCURRENCES_HIGHERRANK <- "https://doi.org/10.15468/dl.yy7vwz"

# File with GBIF occurrences of species in checklist
FILE_OCCURRENCES_CHECKLIST <- "data/processed/registros-presencia-lista-taxonomica-referencia-mamiferos-gbif.csv"

# File with GBIF occurrences in higher rank (e.g. class, order)
FILE_OCCURRENCES_HIGHERRANK <- "data/processed/registros-presencia-mamiferos-gbif.csv"

# Number of records in the raw (initial) checklist
N_RAW_CHECKLIST <- 257

# Vernacular name of higher taxonomic group
HIGHERTAXONOMICGROUP_VERNACULAR <- "mamíferos"

# Scientific name of higher taxonomic group
HIGHERTAXONOMICGROUP_SCIENTIFIC <- "Mammalia"

# Species name example
SPECIES_NAME_EXAMPLE <- "Puma concolor"
```
...
n <- n_distinct(occurrences_checklist$order)
# colors <- rainbow(n)
...
i = 1
for (taxon in unique(occurrences_checklist$order)) {
  # Subset data for current taxon
  taxon_data <- occurrences_checklist[occurrences_checklist$order == taxon, ]
