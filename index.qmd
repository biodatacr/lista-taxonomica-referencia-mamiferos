...
La siguiente tabla muestra las **`r checklist_n` especies** de la lista. Con los controles de la tabla, puede modificar la cantidad de especies desplegadas, ordenar los datos y realizar búsquedas. 
...
checklist |>
  ...
  datatable(
    colnames = c("Orden", "Familia", "Nombre científico"),
    options = list(
      pageLength = 5,
