...
### 2. Lista intermedia
Se removieron de la lista inicial aquellas filas que no corresponden a datos (ej. título, autor, fecha, etc.) y el resultado se guardó en formato CSV, como una [lista intermedia](data/raw/mamiferos _2020.csv). De esta manera, se obtuvo un conjunto de datos debidamente estructurado, con una fila por cada especie y una columna por cada elemento de datos.
...
La [lista final](data/processed/lista-taxonomica-referencia-mammalia-cr.csv) consta de los 257 nombres de especies de la lista original, revisados y corregidos, junto con los restantes elementos de datos recuperados de la Lista de referencia taxonómica de GBIF.
...
### Lista final
La siguiente tabla muestra las `r nrow(checklist)` especies de la lista final. Con los controles, puede modificar la cantidad de especies desplegadas, ordenar los datos y realizar búsquedas. 
